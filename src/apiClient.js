...
export const api = {
  ...
  saveResult:   (data)                          => fetch('/api/results/save', { method:'POST', headers:{'Content-Type':'application/json'}, body: JSON.stringify(data) }).then(r => r.json()),
  getResults:   ()                              => get('/api/results/list'),
  getLeaderboard: ()                            => get('/api/results/leaderboard'),
  saveChallengeEntry: (data)                    => fetch('/api/challenge/submit', { method:'POST', headers:{'Content-Type':'application/json'}, body: JSON.stringify(data) }).then(r => r.json()),
}
